#!/usr/bin/env bash
#[SOURCE OF TRUTH FOR BoardScrub#BuildPageOfFoundLinks GRID seattlerules]
#BLOG POSTS
mvn -Dbrowser="CHROME" -Dinput="http://www.seattlerules.com/blog/" -Dreport="seattlerulesblogposts" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[@href='https://wordpress.org/']" -DlinkXpath="//h2[@class='entry-title']/a" -DnextLinkXpath="//a[@class='next page-numbers']" -DbodyTextXpath="//div[@class='entry-content']/p" -DimageXpath="//div[@class='entry-content']//img" -DtitleTextXpath="//h1[@class='entry-title']" -DaHubPort="4444" -DaHubServer="localhost" -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#=====================================
