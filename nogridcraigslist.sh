...
#FREE STUFF IN EXCELLENT OR NEW CONDITION
mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME -Dinput="https://seattle.craigslist.org/search/zip?condition=10&condition=20&condition=30" -Dreport="computergigs" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#SEATTLE COMPUTER GIGS
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME -Dinput="https://seattle.craigslist.org/search/cpg" -Dreport="computergigs" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#GENERAL SEARCH - HUFFY
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME -Dinput="http://seattle.craigslist.org/search/sss?query=huffy&sort=rel" -Dreport="huffybikes" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#BOISE JOBS
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME -Dinput="http://boise.craigslist.org/search/fbh" -Dreport="boisehospitalityjobs" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#SEATTLE ETC JOBS
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -DnoImages -Dbrowser=CHROME -Dinput="https://seattle.craigslist.org/search/etc" -Dreport="seattlesoftwarejobs" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#SEATTLE SOFTWARE JOBS
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -DnoImages -Dbrowser=CHROME -Dinput="https://seattle.craigslist.org/search/sof?query=selenium" -Dreport="seattlesoftwarejobs" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#SEATTLE HOMES
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME  -Dreport="seattlerealestate" -Dinput="https://seattle.craigslist.org/search/apa?search_distance=5&postal=98107&min_price=500&max_price=1200&max_bedrooms=1&minSqft=300&availabilityMode=0" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#OLYMPIA HOMES
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME  -Dreport="olympiarealestate" -Dinput="http://seattle.craigslist.org/search/rea?search_distance=25&postal=98504&min_price=10000&max_price=50000&availabilityMode=0" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#BAINBRIDGE HOMES
#mvn -DthrottleDownWaitTimeMilliSeconds=0 -Dbrowser=CHROME  -Dreport="bainbridgerealestate" -Dinput="http://seattle.craigslist.org/search/rea?search_distance=15&postal=98110&min_price=10000&max_price=50000&availabilityMode=0" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#PORT ORCHARD HOMES
#mvn -DwaitAfterPageLoadMilliSeconds=3000 -Dbrowser=CHROME -Dreport="portorchardrealestate" -Dinput="http://seattle.craigslist.org/search/rea?search_distance=15&postal=98366&min_price=20000&max_price=55000&availabilityMode=0" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#POULSBO HOMES
...
#OLYMPIA HOMES
#mvn -Dbrowser=CHROME -Dreport="olympiarealestate" -Dinput="http://seattle.craigslist.org/search/rea?search_distance=15&postal=98504&min_price=15000&max_price=55000&availabilityMode=0" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#BOISE HOMES
