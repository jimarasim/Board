...
#OLYMPIA HOMES
mvn -Dbrowser=CHROME -Dreport="olympiarealestate" -Dinput="http://seattle.craigslist.org/search/rea?search_distance=10&postal=98504&min_price=15000&max_price=55000&availabilityMode=0" -DnoScreenShots -DnoScroll -DlinksLoadedIndicatorXpath="//a[contains(text(),'help')]" -DlinkXpath="//a[contains(@class,'result-title')]" -DnextLinkXpath="//a[contains(@class,'button next')]" -DbodyTextXpath="//section[@id='postingbody']" -DimageXpath="//div[contains(@class,'slide first')]/img" -DtitleTextXpath="//h2[@class='postingtitle']" -Dnogrid -Dtest="BoardScrub#BuildPageOfFoundLinks" test
#BOISE HOMES
